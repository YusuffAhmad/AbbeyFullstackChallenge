    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    UserName = table.Column<string>(unicode: false, fixedLength: true, maxLength: 256, nullable: false),
                    ...
                    FirstName = table.Column<string>(unicode: false, fixedLength: true, maxLength: 30, nullable: true),
                    LastName = table.Column<string>(unicode: false, fixedLength: true, maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatePosted = table.Column<DateTime>(nullable: false),
                    AuthorId = table.Column<string>(nullable: true),
                    CommentedPostId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
